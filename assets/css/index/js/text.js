...
window.setInterval(doInverseSpinZeroPitch,150);});$(function(){$(".typed").typed({strings:['Me',"Fazliddin","Coder","good conversationalist ","Python beginner","Learn Python / Html"],typeSpeed:100,loop:true,cursorChar:"|",});});
